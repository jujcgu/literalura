...
public class Principal {
    ...
    private Libros crearLibro(DatosLibros datosLibros, Autores autor) {
        if (autor != null) {
            ...
            System.out.println("El autor es nulo, no se puede crear el libro");
            return null;
        }
    }
    ...
    private void agregarLibros() {
        ...
        if (!datos.resultados().isEmpty()) {
            ...
            if (libroRepositorio != null) {
                ...
                Autores autorRepositorio = autoresRepository
                        .findByNameIgnoreCase(datosLibro.autor().get(0).nombreAutor());
            ...
            System.out.println("El libro no se encuentra por el momento, ingrese otro");
        }
    }
    ...
    private void autoresPorAño() {
        ...
        teclado.nextLine();
        if (año < 0) {
            System.out.println("El año no puede ser negativo, intenta otro");
            return;
        }
        List<Autores> autoresPorAño = autoresRepository
                .findByAñoNacimientoLessThanEqualAndAñoMuerteGreaterThanEqual(año, año);
        if (autoresPorAño.isEmpty()) {
            System.out.println("No hay autores registrados en este año");
            return;
        }
    ...
    private void topDiezLibros() {
        ...
        if (opcion == 1) {
            System.out.println("LOS 10 LIBROS MÁS DESCARGADOS EN EL API GUTENDEX SON: \n");
    ...
    private void estaditicasApi() {
        ...
        if (opcion == 1) {
            System.out.println("ESTADÍSTICAS DE DESCARGAS EN EL API GUTENDEX: \n");
            var json = consumoApi.obtenerDatos(URL_BASE);
            Datos datos = conversor.obtenerDatos(json, Datos.class);
